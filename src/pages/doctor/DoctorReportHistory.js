...
class DoctorReportHistory extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        const url = "/user/" + this.props.user.id + "/fetch_doctor_reports/?search=";
    ...
    /*Items page*/
    searchAction = async () => {
        const url = "/user/" + this.props.user.id + "/fetch_doctor_reports/?search=" + this.state.searchValue;
        const response = await backend.get(url);
        this.setState({reports: response.data.data.reports});
    };
    ...
    renderReports = () => {
        ...
        return this.state.reports.map((report, key) => {
            return (
                <ReportCard key={key} report={report} userId={this.props.user.id} onClickButton={
                    () => {
        ...
        return (
            ...
            >
                ...
                <Field>
                    ...
                    <SendToComponent user={this.props.user} pushSelected={
                        (selected) => {
...
export default connect(mapStateToProps, {getUser})(DoctorReportHistory);